...
from Event.EventHandler import (BarHandler, PriceHandler, FillHandler, ENDHandler)
from Event.EventQueue import EVENT_QUEUE
from BaseType.Const import CONST


class PriceStrategyUnit(Subject, PriceHandler, FillHandler, ENDHandler):
    _name = "PriceStrategyUnit"
...
class BarStrategyUnit(Subject, BarHandler, FillHandler, ENDHandler):
    _name = "BarStrategyUnit"
